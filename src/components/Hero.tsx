          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.3 }}
            ...
            <div className="relative w-[210px] rounded-[2.2rem] border-[5px] border-white/30 shadow-2xl overflow-hidden bg-white">
              ...
              <div className="px-4 pt-9 pb-4 flex flex-col gap-3 min-h-[340px]">
                ...
                <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noreferrer" onClick={trackWhatsAppConversion} className="flex items-center justify-between text-green-900 hover:opacity-80 transition-opacity group">
